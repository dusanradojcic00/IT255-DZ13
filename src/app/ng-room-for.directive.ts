import { Directive, Input, IterableDiffer, IterableDiffers, TemplateRef, ViewContainerRef, ViewRef } from '@angular/core';

@Directive({
  selector: '[ngRoomFor]'
})
export class NgRoomForDirective {
  private items: any;
